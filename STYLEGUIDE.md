...
Also you can see the latest formatting rules on the [analysis_options.yaml](https://github.com/mastodon-dart/mastodon-oauth2-pkce/blob/main/analysis_options.yaml)!
